...
import { callFetchResumeByUser, callGetSubscriberSkills, callUpdateSubscriber, callUpdateUser } from "@/config/api";
...
const UserUpdateInfo = (props: any) => {
    ...
    const onFinish = async (values: any) => {
        ...
        if (res?.data) {
            dispatch(setUserLoginInfo({ ...user, name: values.name }));
